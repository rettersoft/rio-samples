...
export interface SubscribeInputModel {
    email: string;
}
...
const typeMap: any = {
    "RioModelsObject": o([
        { json: "SubscribeInputModel", js: "SubscribeInputModel", typ: u(undefined, r("SubscribeInputModel")) },
        { json: "Subscriber", js: "Subscriber", typ: u(undefined, r("Subscriber")) },
    ], "any"),
    "SubscribeInputModel": o([
...
export class EmailSubscriber {
     ...
     * @returns {Promise<EmailSubscriber>}
     */
    public static async getInstance(options?: RetterRequest<any>): Promise<EmailSubscriber> {
        const rdk = new RDK()
        ...
        if (result && 200 <= result.statusCode && result.statusCode < 300) {
            const _instance = new EmailSubscriber(result.body.instanceId)
    ...
    /**
 * calls subscribe on EmailSubscriber
 * @param {SubscribeInputModel} body - payload
 * @param {RDKOptions} options - other method call parameters
 * @returns {Promise<RetterResponse<any>>}
 */
public async subscribe(body?: SubscribeInputModel, options?: RDKOptions): Promise<RetterResponse<any> | undefined> {
...
/**
 * calls preSubscribe on EmailSubscriber
 * @param {SubscribeInputModel} body - payload
 * @param {RDKOptions} options - other method call parameters
 * @returns {Promise<RetterResponse<any>>}
 */
public async preSubscribe(body?: SubscribeInputModel, options?: RDKOptions): Promise<RetterResponse<any> | undefined> {
    return await this._rdk.methodCall({
        ...options,
        classId: 'EmailSubscriber',
        instanceId: this.instanceId,
        lookupKey: this.lookupKey,
        methodName: 'preSubscribe',
        body,
    })
}

/**
 * calls unSubscribe on EmailSubscriber
 * @param {SubscribeInputModel} body - payload
 * @param {RDKOptions} options - other method call parameters
 * @returns {Promise<RetterResponse<any>>}
 */
public async unSubscribe(body?: SubscribeInputModel, options?: RDKOptions): Promise<RetterResponse<any> | undefined> {
    return await this._rdk.methodCall({
        ...options,
        classId: 'EmailSubscriber',
        instanceId: this.instanceId,
